...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List ref={ref} className={cn("inline-flex min-h-9 max-w-full flex-wrap items-center gap-1 rounded-md bg-surface-sunken p-1 text-text-muted", className)} {...props} />
));
